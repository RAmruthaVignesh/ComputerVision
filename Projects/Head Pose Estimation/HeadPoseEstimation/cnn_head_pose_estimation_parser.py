...
def create_csv(input_path, output_path, img_size=64, colour=True, normalisation=False):
    ...
    fd.write("path, id, serie, tilt, pan, label" + "\n")
    fd.close()
    ...
    for folder in os.walk(input_path + "/"):
        for image_path in glob.glob(str(folder[0]) + "/*.jpg"):
            ...
            if str(label_pan+label_tilt) == "FLFU" : class_label = 0
            elif str(label_pan+label_tilt) == "FLSU": class_label = 0
            elif str(label_pan+label_tilt) == "FLC": class_label = 1
            elif str(label_pan+label_tilt) == "FLSD": class_label = 2
            elif str(label_pan+label_tilt) == "FLFD": class_label = 2
            elif str(label_pan+label_tilt) == "SLFU" : class_label = 0
            elif str(label_pan+label_tilt) == "SLSU": class_label = 0
            elif str(label_pan+label_tilt) == "SLC": class_label = 1
            elif str(label_pan+label_tilt) == "SLSD": class_label = 2
            elif str(label_pan+label_tilt) == "SLFD": class_label = 2
            elif str(label_pan+label_tilt) == "CFU" : class_label = 3
            elif str(label_pan+label_tilt) == "CSU": class_label = 3
            elif str(label_pan+label_tilt) == "CC": class_label = 4
            elif str(label_pan+label_tilt) == "CSD": class_label = 5
            elif str(label_pan+label_tilt) == "CFD": class_label = 5
            elif str(label_pan+label_tilt) == "SRFU" : class_label = 6
            elif str(label_pan+label_tilt) == "SRSU": class_label = 6
            elif str(label_pan+label_tilt) == "SRC": class_label = 7
            elif str(label_pan+label_tilt) == "SRSD": class_label = 8
            elif str(label_pan+label_tilt) == "SRFD": class_label = 8
            elif str(label_pan+label_tilt) == "FRFU" : class_label = 6
            elif str(label_pan+label_tilt) == "FRSU": class_label = 6
            elif str(label_pan+label_tilt) == "FRC": class_label = 7
            elif str(label_pan+label_tilt) == "FRSD": class_label = 8
            elif str(label_pan+label_tilt) == "FRFD": class_label = 8

            fd.write(output_dir + "," + str(int(person_id)) + "," + str(int(person_serie)) + "," + \
                     str(label_tilt) + "," + str(label_pan) + "," + str(class_label) + "\n")
            fd.close()
            counter += 1
